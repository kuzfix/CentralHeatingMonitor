...
//F_CPU=16MHz/8 = 2MHz
#define 	XPT2046_SPCR_value ((0<<SPIE) | (1<<SPE) | (0<<DORD) | (1<<MSTR) | (0<< CPOL) | (0<<CPHA) | (1<<SPR0))
#define 	XPT2046_SPSR_value (1<<SPI2X)
...
#define XPT2046_DDR_IRQ		DDRB
#define XPT2046_PORT_IRQ	PORTB
#define XPT2046_PIN_IRQ		PINB
#define XPT2046_BIT_IRQ		1
